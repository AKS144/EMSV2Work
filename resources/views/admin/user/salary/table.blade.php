...
<div class="page-wrapper">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2 btn-dark btn-sm btn-round pull-right">Net Salary <i class="fa fa-usd"></i>
            <b>{{$salary_amount->salary_amount}}</b>
        </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content collapse">
                    {{-- <form action="{{route('managesalary.detail',Auth::user()->id)}}" method="GET"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class=" date col-md-5">
                                <input type='text' value="{{request()->startdate}}" id="startDate" name="startdate"
                            ...
                            <div class="date" id="search">
                                <button type="submit" class="btn btn-round btn-success"><i class="fa fa-search"></i>
                                    Search</button>
                            </div>
                            {{-- </div> --}}
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="fa fa-usd"></i> @if ($originalBalance == 0)
                                            <span
                                                style="color:red">{{$originalBalance + ($transaction->salary_amount - $transaction->amount)}}</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="no-print">
                                            <div class="btn-group">
                                                <a href="{{route('user.edit',$transaction->id)}}"
                                                    class="btn-info btn-xs btn-round" title="print invoice"><i
                                ...
                                @if($employee_advance_salary)
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-print">
                                            <div class="btn-group">
                                                <a href="{{route('user.edit',$transaction->id)}}"
                                                    class="btn-info btn-xs btn-round" title="print Advance Invoice"><i
                                                        class="fa fa-print"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                @if($employee_overtime_salary)
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-print">
                                            <div class="btn-group">
                                                <a href="{{route('user.edit',$transaction->id)}}"
                                                    class="btn-info btn-xs btn-round" title="Print Overtime Invoice"><i
                                                        class="fa fa-print"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-print">
                                            <div class="btn-group">
                                                <a href="{{route('user.edit',$transaction->id)}}"
                                                    class="btn-info btn-xs btn-round" title="print bonus invoice"><i
                                                        class="fa fa-print"></i></a>
                                            </div>
                                        </td>
                                    </tr>
