<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="icon" href="{{asset('uploads/gallery/admin-settings-male.png')}}" type="image/gif" sizes="16x16">
...
<script src="{{asset('admin-panel/assets/jquery.lighter.js')}}" type="text/javascript"></script>
<link href="{{asset('admin-panel/assets/jquery.lighter.css')}}" rel="stylesheet" type="text/css" />
    <!-- Custom CSS -->