...
use App\TeamMember;
 ...
 $team_members = TeamMember::where('employee_id', auth()->user()->id)
 ->first();
...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu menu_fixed">
  ...
  @can('isAdmin')
      ...
      <li class="sidebar-item"><a href="{{route('project.index')}}" class="sidebar-link"><i class="fa fa-tasks "></i><span class="hide-menu"> Projects</span></a></li>
      <li class="sidebar-item"><a href="{{route('team.index')}}" class="sidebar-link"><i class="fa fa-tasks "></i><span class="hide-menu"> Teams</span></a></li>
      <li class="sidebar-item"><a href="{{route('task.index')}}" class="sidebar-link"><i class="fa fa-tasks "></i><span class="hide-menu"> Tasks</span></a></li>
      @endcan

     @if($projectManager ||  $team_members)
      <li class="sidebar-item"><a href="{{route('project.index')}}" class="sidebar-link"><i class="fa fa-tasks "></i><span class="hide-menu"> Projects</span></a></li>
      <li class="sidebar-item"><a href="{{route('team.index')}}" class="sidebar-link"><i class="fa fa-tasks "></i><span class="hide-menu"> Teams</span></a></li>
      <li class="sidebar-item"><a href="{{route('task.index')}}" class="sidebar-link"><i class="fa fa-tasks "></i><span class="hide-menu"> Tasks</span></a></li>
      <li class="sidebar-item"><a href="{{route('chat.index')}}" class="sidebar-link"><i class="fab fa-whatsapp fa-lg "></i><span class="hide-menu"> ChatRoom</span></a></li>
      @endif
