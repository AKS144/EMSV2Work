...
Route::group(['middleware' => 'auth'], function () {
    ...
    // PROJECTS ROUTES
    // Route::get('projectS',               [ 'as'=>'project',              'uses' => 'ProjectController@project']);
    // Route::get('projectS',               [ 'as'=>'project',              'uses' => 'ProjectController@project']);
    // Route::get('projectS',               [ 'as'=>'project',              'uses' => 'ProjectController@project']);
    Route::Resource('project', 'ProjectController');
    Route::Resource('project_manager', 'ProjectManagerController');
    Route::Resource('task', 'TaskController');
    Route::Resource('team', 'TeamController');
    Route::Resource('assigned', 'AssignedController');
    Route::post('team/update/{id}', 'TeamController@UpdateTeam');
    Route::delete('team/delete/{id}', 'TeamController@delete')->name('team.delete');
    Route::Resource('team_member', 'TeamMemberController');

    Route::put('user/project',  ['as' => 'user_project.index',  'uses' => 'ProjectController@UserProjectIndex']);
    Route::put('user/team',  ['as' => 'user_team.index',  'uses' => 'ProjectController@UserTeamIndex']);


    // Chat App Route

    Route::Resource('chat', 'ChatMessageController');
    // Route::get('chat/{id}',  [ 'as'=>'chat.show',  'uses' => 'ChatMessageController@index']);

    Route::get('fetch_employee_chat_history',  ['as' => 'fetch_chat_history',  'uses' => 'ChatMessageController@fetch_employee_chat_history']);
    Route::get('unRead_messages',  ['as' => 'count_unRead_messages',  'uses' => 'ChatMessageController@count_unRead_message']);
    Route::put('is_Typing/{id}',  ['as' => 'Update_is_Typing',  'uses' => 'ChatMessageController@Update_IsTyping']);
    Route::delete('delete/{id}',  ['as' => 'Delete_Chat',  'uses' => 'ChatMessageController@Delete_Signle_ChatMessage']);

    Route::put('online_status/{id}',  ['as' => 'Online_Status',  'uses' => 'ChatMessageController@IsOnline_User']);
    Route::put('offline_status/{id}',  ['as' => 'Offline_Status',  'uses' => 'ChatMessageController@IsOffline_User']);

    Route::put('read_message/{id}',  ['as' => 'read_message',  'uses' => 'ChatMessageController@MessageRead']);


    Route::post('group_chat_store',  ['as' => 'group_chat_store',  'uses' => 'ChatMessageController@GroupChatStore']);
    Route::get('fetch_employee_groupchat_history',  ['as' => 'fetch_groupchat_history',  'uses' => 'ChatMessageController@fetch_employee_groupchat_history']);
    Route::post('upload_chat_file',  ['as' => 'upload_chat_file',  'uses' => 'ChatMessageController@upload_ChatFiles']);
    // Route::get('fetch_projectmanager_chat_history',  [ 'as'=>'fetch_chat_history',  'uses' => 'ChatMessageController@fetch_employee_chat_history']);



    Route::post('store', ['as' => 'chat_file_store',  'uses' => 'ChatMessageController@uploadImages']);
    Route::post('delete', ['as' => 'chat_file_delete',  'uses' => 'ChatMessageController@deleteImage']);
