...
//            'status' => 'required',
       ...
       $user -> status = $request -> status;
        ...
        $employment_salary = Salary::create(
        ['employee_id' => $user->id,
        ...
        Toastr::success('Employee Fail to add!','Error');
        return redirect()->route('user')->with('error','Employee Fail to add!');
    }
